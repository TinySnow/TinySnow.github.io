...
- 强烈推荐中国大陆用户访问国内镜像网站：[http://tinysnow.gitlink.net](http://tinysnow.gitlink.net)，其他镜像网站见联系方式。
- We strongly recommend that users in China mainland visit the domestic mirror website: [http://tinysnow.gitlink.net](http://tinysnow.gitlink.net). For other mirror websites, please see the contact information.
- 中国本土のユーザーには、国内向けミラーサイト（[http://tinysnow.gitlink.net](http://tinysnow.gitlink.net)）のご利用を強くお勧めします。その他のミラーサイトについては、連絡先情報をご覧ください。
- Nous recommandons vivement aux utilisateurs de Chine continentale de consulter le site miroir local : [http://tinysnow.gitlink.net](http://tinysnow.gitlink.net). Pour les autres sites miroirs, veuillez consulter les informations de contact.
