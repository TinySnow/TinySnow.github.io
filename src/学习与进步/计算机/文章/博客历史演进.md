...
- [自己写的脚本](https://github.com/TinySnow/TinySnow.github.io/blob/master/assets/generate-last-updated-md.sh)，用来生成“last-updated.md”
...
- 写[脚本](https://github.com/TinySnow/TinySnow.github.io/blob/master/assets/generate-last-updated-md.sh)花了一段时间，也犯了比较多的错，直到现在这个脚本都有 bug，而且不通用，不过也懒得改了
