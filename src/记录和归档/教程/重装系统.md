...
30. QQ 屏幕录制热键取消
31. Wallpaper Engine 设置高优先级
32. Store 下载 PIxPin
33. Store 下载 Windows Terminal
34. 更改 Snipaste 快捷键 Ctrl+Windows+A
35. Keepass -> 工具 -> 选项 -> 集成 -> Ctrl+Alt+S
36. Keepass -> 显示 -> 选择语言
37. FireFox 设定
...
38. ProxySwitchyOmega -> 设置
39. 安装好所有软件后任务管理器更改开机启动
40. ESET 解除链接和重新设置
41. 修改设备名字
42. 更改 Telegram 下载文件夹
43. 导入浏览器脚本
...
46. 登录 GitHub，打开 star 复制 Host
47. 导入 Tempermonkey 脚本，位于 toolsets
48. FastImage Viewer 设定
